...
const WishList = () => {
  ...
  // Mock price history data for each item
  ...
  const handleShareItem = (item: WishListItemType) => {
    ...
    const shareUrl = `${window.location.origin}/shared/${wishList?.shareId}?item=${item.id}`;
          ...
          <div className="md:flex md:items-center md:justify-between">
              ...
              {isLoading ? (
                ...
                <>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    {filteredItems.length} items - Updated{" "}
                    {wishList
            ...
            <div className="mt-4 flex md:mt-0 md:ml-4 space-x-3">
              <ShareListModal
                ...
                wishlistTitle={wishList?.title || "My Wishlist"}
              >
        ...
        {filteredItems.length > 0 && (
          <div className="mt-8 flex justify-center">
            <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
              ...
              <a href="#" className="relative inline-flex items-center px-4 py-2 border border-gray-300 bg-primary text-sm font-medium text-white hover:bg-opacity-90">
                1
              </a>
